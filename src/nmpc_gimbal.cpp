...
int main(int argc, char **argv)
{
    ...
    gimbal_sub = nh.subscribe("/uav0/gimbal/joint_states", 10, getGimbalState);
    pitchVelCommand_pub = nh.advertise<std_msgs::Float32>("/uav0/gimbal/pitch/cmd_joint_velocity", 10);
    yawVelCommand_pub = nh.advertise<std_msgs::Float32>("/uav0/gimbal/yaw/cmd_joint_velocity", 10);
    ...
    while(ros::ok()){
        ...
        // lbg.insert(lbg.end(), final_lbg.begin(), final_lbg.end());
        // ubg.insert(ubg.end(), final_ubg.begin(), final_ubg.end());
        // lbx = {-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04,-1.04};
        // ubx = {1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04,1.04};
        // lbg = {-3.14,-3.14,0,-3.14,-3.14,0,-3.14,-3.14,0,-3.14,-3.14,0,-3.14,-3.14,0,-3.14,-3.14,0,-3.14,-3.14,0,-3.14,-3.14,0,-3.14,-3.14,0,-3.14,-3.14,0};
        // ubg = {3.14,0.0,inf,3.14,0.0,inf,3.14,0.0,inf,3.14,0.0,inf,3.14,0.0,inf,3.14,0.0,inf,3.14,0.0,inf,3.14,0.0,inf,3.14,0.0,inf,3.14,0.0,inf};
        // lbg = {-inf,-inf,0};
        // ubg = {inf,inf,inf};
        arg["lbx"] = lbx;
        arg["ubx"] = ubx;
